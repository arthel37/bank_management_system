...
namespace BMS.BankDBDataSetTableAdapters {
...
SELECT id, username, password FROM login WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BMS.Properties.Settings.Default.BankDBConnectionString;
        }
        ...
        public virtual int Fill(BankDBDataSet.loginDataTable dataTable) {
        ...
        public virtual BankDBDataSet.loginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BankDBDataSet.loginDataTable dataTable = new BankDBDataSet.loginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BankDBDataSet.loginDataTable dataTable) {
